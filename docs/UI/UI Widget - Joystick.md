...
<strong>摇杆</strong>是通过虚拟摇杆控制角色的移动和转向的工具，可用于制作控制人物移动的摇杆、按住一边射击一边转动视角的开火键、需要瞄准的技能等。
...
- 在为 PC 游戏端玩家设计控制方案时，为了<strong>避免按键绑定与</strong><strong>直接</strong><strong>点击 UI 产生冲突</strong>，需要合理的运用此项属性，例如：
