...
![](static/boxcndWr09C5ra5oh6gdkKCkR2g.png)

![](static/boxcnUBA18BtZLWi2va3tre6QDc.png)

- 布局是容器的独有属性，主要作用是将容器内的所有子项进行有规则的排序，方便用户进行使用。
- 举例说明：背包功能就是典型利用容器布局所制作的 UI 效果。
- 示意图：

![](static/boxcn4V8N1j9wLi8gqGJweYl2qg.png)
...
![](static/boxcnmTJ2mNKZI4Go3UkLxrqAFe.png)
...
![](static/boxcnHIxN8R3rEltxMBxNyTsXvh.png)
...
![](static/boxcnkdyeGpGYysxiJpJzzTpV1e.png)
...
![](static/boxcndTrAYxQqsQ8LDeMJUYwvNc.png)
...
![](static/boxcnBEYyIEEq2vlbZ77zbhwCQc.gif)
...
![](static/boxcnmMXoiVC5secAajnMCXogFh.gif)
...
![](static/boxcnyqW1DABhRMqnmhZlZPIYzb.png)

- 将从左到右属性修改为从右到左，从上到下属性改为从下到上。

![](static/boxcnmBozgbdPuJisxurjrikync.png)

- 再举例说明：开启网格布局的默认情况下，将容器类型设置为垂直布局，排列规则设置为右上对齐。

![](static/boxcnfNbVkYbvrARQ0NByokpqYd.png)

- 将从左到右属性修改为从右到左，从上到下属性改为从下到上。

![](static/boxcn6lenGSS6jci4DuzdnJlupb.png)
...
![](static/boxcncA6nH9CpQgflWEkT4XT8Qh.gif)
...
![](static/boxcnjJSMrtjfu5HR29qyaRvPgc.png)

![](static/boxcnlHQpKpDRl69wymJ0x5g0Dd.png)
...
![](static/boxcnWCPp8wXO1mVZ86z3Wc53cb.gif)
