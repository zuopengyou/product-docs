...
那么如何优化这一比率呢？
- 首先可以优化播放按钮的曝光率，比如说原本的曝光入口藏在深处，比如说观看广告获得服饰，用户在点击衣柜的某一服饰（已明确表示可以看广告获取）后，再次出现弹窗提示看广告可以获得此装扮，不妨可以试试点击服饰后直接弹出广告；其次可以试着优化按钮的点击率，比如说一个跑酷游戏，可通过看广告获取一些资源（右图），假设这个按钮点击率不高，我们可以尝试优化按钮的UI，让它变得更显眼一点，刺激用户点击，比如说放大，改颜色，放个生动形象的icon等。

![](https://cdn.233xyx.com/athena/online/a76d27d1310940339c9a65b9dcb590a6_16874320.webp)
