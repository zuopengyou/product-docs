...
| ***标签***                                  | ***描述***                                                   | ***示例***                                                   |
| ------------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
|                                      | 以粗体显示文本                                               | We are <b>not</b> amused.                                    |
| **或** | 根据参数值#rrggbbaa设置文本的颜色，分别表示颜色的红、绿、蓝和 Alpha（透明度）值，大小写都能识别20种常用颜色可以直接使用颜色名称，大小写都能识别 | We are colorfully amusedWe are colorfully amused |
|                                      | 以下划线显示文本                                             | We are <u>not</u> amused.                                    |
