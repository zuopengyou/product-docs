...
**027版本升级手册：**[‌⁡⁤⁤⁢⁣⁤‍‌⁢﻿⁤‌⁣⁣‍﻿‍﻿⁡⁢⁢‍‬‬‬⁡‌﻿⁢﻿⁡⁡⁡﻿﻿⁤⁤⁣⁡⁣0.27.0.0版本更新手册 副本 - MetaApp云文档 (feishu.cn)](https://meta.feishu.cn/wiki/Vd7RwKXTVi8RmKkA0r5cYJa7nVb) 目前暂时还是飞书链接，之后会替换成产品手册链接

**所有API变动列表：**[API变动列表](https://docs.ark.online/ReleaseNote/Special/API变动列表.html)
...
- 在角色编辑器的菜单栏中添加“设置”菜单。
- 设置菜单中包含选项*“**默认显示挂件**”*。
- 勾选后，启动客户端时，在角色编辑器内设置的挂件将结合相关数据，自动插在对应插槽上。

![img](https://arkimg.ark.online/1695707946428-10.webp)
...
- 新增**不再提示**选项，若在保存时勾选该选项，则在重新打开该工程前，都不再进行保存弹窗提示，触发保存时，默认保存所有角色数据。
...
在角色编辑器中隐藏二次元前后发的【高光颜色】调节项，同时废弃该TS接口。
...
- 从027开始，也可以从【资源库-游戏功能对象】中拖出或者在脚本中动态创建任意个摄像机对象，这些摄像机对象可以被放置在场景中的任意位置，或者挂载到其他对象下作为子级对象；
- 世界对象-摄像机与游戏功能对象-摄像机都可以通过脚本中Camera类的属性/接口来调整效果，用法详见 [摄像机 | 产品手册](https://docs.ark.online/WorldObjects/Camera.html)
- 游戏功能对象-摄像机的模型及弹簧臂（红色细线）会展示在场景中，便于大家理解摄像机对象的各项参数（例如下右两张图，可以清晰展示摄像机相对旋转与弹簧臂相对旋转的区别）；世界对象-摄像机的模型也将在后续版本中暴露出来
...
[二次元新旧捏脸对比](https://meta.feishu.cn/wiki/FNUMwBrtsiGEXFk7Aq5cUgYjnPc) 
...
- 角色属性面板中新增【角色音效】属性，用户可以通过属性面板调整相关的音效。

![img](https://arkimg.ark.online/1695707946430-28.webp)



#### [新增]角色简单移动策略

- 我们提供了简单移动策略，在该移动模式下，摩擦力、加速度等参数会失效，并且不会进行浮空检测，同时角色动画模式将会变为自定义动画模式，方便开发者自定义移动效果和角色表现。
- 相关接口：
...
![img](https://arkimg.ark.online/1695724730784-55.webp)
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=MWM1MDM0ODRkZTRmMWI3ZDQzMGVhNGRiNjY2NWNjOGJfa2h4SFpTQUU3Y2l0blBzTmZudWd5cEc4QUdUazBuaU5fVG9rZW46Q2hsdmJGSFM5b1hHd1J4enNrZ2NxbDVObnhNXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 光照亮度

预设光照偏移值，调节该值修改场景晚上->白天，越小越暗。取值范围0 ~ 1，默认值为 1。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZGU0ODk3OTdhYmEzNmNjOWQzMjgwODQ1N2IzNzBhMDFfdkZibm9obFdWNWllZkp1M0t5UGYzWHpLTVRzMmNvYUpfVG9rZW46TWZRbGJXRTV1b1pBY294RUpjU2NXZzY1blZmXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 偏色值

光照颜色偏移值，调节该值修改场景中光照颜色。默认值为 FFFFFFFF 白色。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=NzllZWE5MzAzOGFjMjg5OGQwMTc0YjgwNmVmMWUyMjNfdFhFQnd3SGpKWEExNlFmQXdEMXpQcTE2M0ZjUGt4RzNfVG9rZW46UWczbmI2d1lQb2tCejF4SzlYNGNCUzdtbnViXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 朝向角度

光线的朝向角度，调节该值修改场景中光线来源的方向。取值范围-180 ~ 180，默认值为 -60。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZWYyN2QwOWI3YmQ2MTM1MTM2NjFhODdjODdjMWE2OTBfM0xVWjI1Y2dLeFVDQ3lwUUE2bnFvaUREeHlueGdwbDJfVG9rZW46SHV0MWJub0U3bzRXMTl4M2RxZ2NyS1lZbnBjXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 俯仰角度

光线的俯仰角度，调节该值修改场景中光线与地面的夹角。取值范围-90 ~ 90，默认值为 -60。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=MGVmYmYzMzNiNjlkZTAyODgwMzE2MTgxMWViYTNmNjhfblBaellTQ2xCQmJ1VTRDamNLb2dEeXNXM1FxNkxaZG9fVG9rZW46WXNoRmJsN1kybzlsYXF4OHQ3YmNGV1BDbmJlXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZWM2MmU5M2E4MWNkNjk5NDUyZTJhNmRiMjNiMTY0ZDdfb2ZtaEpxTzF3aGlDM2NTcXNNSWk3d2poY2ZIcUo5aXJfVG9rZW46QXdMNmJKcWwwb0VhTHN4MDRZV2Nid0JKbjNjXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 是否开启色温

光照是否应用色温，调节该值开启/关闭色温。默认值为false。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ODI0ZDRmZWU5MjYzNjk1ZjVkZGFlYjkwMWIxZTdhNGJfNUpnRXdDR0NDSzFlTThUVlZtMmM3aFB5V3VVWmtPZE5fVG9rZW46QmlQQ2JDRWdWb1dlNUV4RkpGVmNIdmFoblBlXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 色温

光照色温值，需要开启色温才会生效。调节该值修改场景中光线色温。取值范围1000 ~ 12000，默认值为 6500。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZmQzNGEwYTBkY2FhNmYzMDY4YzhlOWVhOGE5ZjdlNzhfRk5rd0ZHTjJpbU1QYXFsd2gyRlZWMXpXUEJoTzdQUE9fVG9rZW46V2s1dmJpQWVCb3dZc3h4enVHc2NTd2NDbjdkXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)
...
| 后处理 - PostProcess<br />    后处理预设<br />        预设效果<br />            默认<br />            梦境<br />            反差色<br />            暖阳<br />            老照片<br />            夜幕 <br />            鲜暖色<br />            用户自定义（自动）<br />    后处理设置<br />        泛光<br />        全局饱和度<br />        全局对比度 | ![img](https://arkimg.ark.online/1695724784227-102-1695783165003-253.webp) |
| ------------------------------------------------------------ | ------------------------------------------------------------ |
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=YWZiNTNkYTlmMGQ2ZDJlNGMwYTZjYjMyNzhjMDY3ZWZfOWJYUUlVZ09mV0xGQ3NCZ2Z6UGxUOUNyQ1g3dmRYeHhfVG9rZW46WUQ0ZWIyRnJ4b1plbkd4QnRWc2Nnc29PbnVlXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 全局饱和度

修改该值可以调节镜头颜色的饱和度，取值范围0 ~ 2，默认值为 1.2。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=YzliNThlODNmYTAyNWYyMzAwYjMxYmQ4NTVhZmFhNWNfQlJHRkM2TGh5Y2pQN3BNSzRFcm52OHRJNUpDU2VDRlhfVG9rZW46VmhibmJIOUg4b0ZJRkx4N0pGYWNaSkJ3bmJMXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)

- 全局对比度

修改该值可以调节镜头颜色的对比度，取值范围0 ~ 5，默认值为 1。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=MTU5NzYzYThhOTAyODgwMjNmZDQ4MjNlZTVmZTRjMThfaWFpN1lrMDBvWUViM3BmUUR5U0hEc1RjV0c4UXZEdmJfVG9rZW46QnZ4aWJDMUtOb2JPYWN4cGRlZGNQUVM5bmRoXzE2OTU3MjQ3ODA6MTY5NTcyODM4MF9WNA)
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=MmYzYWFlMDM5OWQxMzc4ZGU3MmVkZWU4NTFjYjE3ODNfd3VYd3BNVUFSS1YyenVoUnVQUUFZc2lLR05iZjRJRkxfVG9rZW46TGp1VWIwWklPb25PM1l4VjRReGNOdllablhkXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=OTA4MzlkMDljOTZlY2YyYzM2YWJhZjZhNjcyMzQwZDVfVTRVTGFOejRUaFRUcHdzVGtCeXRESEFpczU5YVk2ZlVfVG9rZW46U1RYZWJnTzRGb1Q0ZkF4bFZpc2NTVUt4blNmXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)

- 雾高度

雾效的起始世界高度，也就是环境雾Z轴的位置，高度越低，雾的效果越淡，高度越高，雾的效果越浓。取值范围-10000 ~ 10000，默认值为 0。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=NjZmOTEwNDM3NzFhNTkzYjhhZTMxMGI0NTRmY2UxYTNfdU9kMjYweEJrcmVpcFpoamVNZ01GT1dITk5pcUd6RnNfVG9rZW46TlJOemJ4ZFExb3dmYUx4cWdtemNZak1wbjJEXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)

- 雾散射颜色

雾的内散射颜色，就是雾的主要颜色。默认值为#E2E8EBFF白色

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZmQ1M2RmYjc0MmI0NDc1MzZlYWU4MDJmMmFmNzMxODNfSGZ3MzRCdGlmSHd0ekl1V0tHalJ2dkJqVEF0SHdNUWFfVG9rZW46T3NQdGJSTnltb25HMWx4Wm1heGNscFhYbkRnXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)

- 雾最大透明度

雾的最大不透明度。值为1时雾完全不透明，值为0时雾基本不可见。取值范围0 ~ 1，默认值为 1。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=NGU2NGVkMzlmYmJkNTU3ZmMzZGRhNGYwZDZjNWZmYzZfaThBUkNFVjVkZkxsWUE4M29LNU1rZGhUQUR6N2JLV3ZfVG9rZW46QWpPbWJCWXR3b3FaYlh4ODY5cmNxVEN6bm1lXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)

- 起始距离

雾出现处与摄像机的距离。取值范围0 ~ 10000，默认值为 1000。

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=ZGE3YWIyZGQ0ZTVmNjkzOGM1MTkwZWFhYTBhMjVmYTVfcHc1eGpBNGZDV044bkV1cklPaGtBaHBpUlBWVzhKRnBfVG9rZW46Ukw2NmJIdUd5bzFlRkV4U2JTMmNqMFNibkZkXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)
...
![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=YzAwOTk3YTQzY2I2YmViYjkyNDFmYmEzZTUxZGVmYjhfbm1rRWVLMmZ4dzdUaUZpdnZ5TWZsNHRhSnZBb1poR3BfVG9rZW46SjJ0WWJqd3Bsb2lITVZ4cDFyS2NXU2FPbmViXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)

- 太阳光散射颜色

设置在环境雾中太阳光的散射颜色，就是太阳光的主要颜色。默认值为#000000FF黑色

![img](https://meta.feishu.cn/space/api/box/stream/download/asynccode/?code=MDhhZmY2NWE5MWRmMWFlOTJlZWM1ZDNjY2M5NGJhYzdfcjREZ0VTaEJKMzdjVGVrZnRYMGU3WmpFalM3ZnJNeWhfVG9rZW46RnNrdGJxMG5Rb2hpMmJ4cTl3RGNEMkFUbkRiXzE2OTU3MjQ4NDI6MTY5NTcyODQ0Ml9WNA)
