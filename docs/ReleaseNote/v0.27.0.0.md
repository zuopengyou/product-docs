...
​      a. DrawCall会有一定的升高：原因是026的shipping包中没有indirectDraw相关的统计，027统计了。

​      b. 资源下载时间变长，帧率变低：原因材质2.0新增了很多属性，导致资源材质本身变大。

​      c. 同步双端对象完成时间可能会变长：原因是埋点的意义变了，026是主角创建出来就上传；027是主角创建完成并换装完成。

3. PC关闭游戏窗口快捷键修改：

027版本编辑器点击运行后，关闭游戏窗口的快捷键由ESC修改为：Shift+F5。

4. 在安装360(或其他杀毒软件)的前提下打开/运行编辑器时有可能出现风险提示
