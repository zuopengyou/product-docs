...
| 旧版                                                         | 新版                     |
| :----------------------------------------------------------- | :----------------------- |
| CollisionStatus.On<br />queryEnabled = true<br />touchEnabled = false | collisionEnabled = true  |
| CollisionStatus.Off<br />queryEnabled = false<br />CollisionStatus.QueryOnly | collisionEnabled = false |
| CollisionStatus.QueryOnly<br />queryEnabled = true<br />touchEnabled = true | collisionEnabled = false |
