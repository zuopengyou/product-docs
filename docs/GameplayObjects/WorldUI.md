...
![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnMAmfHx6NhmeQlI5WttEcBg.png)

然后将工程内容中做好的 UI 拖拽到世界 UI 属性面板的绑定 UI 对象内，完成绑定后，世界 UI 就会显示在主视口内了。

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcn5bJpAzEDxH62UBGXEMSzje.png)

如果是头顶类型的世界 UI，还需要将世界 UI 对象挂载在人形对象上，并设置好与角色的相对位置

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnh3ZKjUW4hPDoUebDJpxibb.png)

世界 UI 有世界/屏幕/头顶三种类型，以下展开介绍：

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnSiYETEQoInLIIKD3igZLKG.png)

#### 1、世界类型

- 世界类型世界 UI 是将 UI 组件以网格体的形式在世界场景中进行渲染，并且可被遮挡，使得 UI 不再脱离在场景层之外，而是成为场景层的一部分给玩家带来更强的代入感

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnVgh5EbM2vbw1AMQmcCHqEh.gif)

- 世界类型世界 UI 包括以下属性：

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnO0ueU8B4l5fbDOeqnLfZCd.png)

- 几何体模式：世界 UI 界面的形状
- 圆柱体弧形角度：几何体模式为圆柱类型时 UI 界面的角度

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnvgokdofzQGlE73RbbYxgOf.png)

平面

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnm5y0cKMp5pQXcPuxpQ72re.png)

圆柱-180°

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnO72wfYkyGb5cTId6PxhZgd.png)
...
![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnJzF544YortUqz5G3qKLq2d.png)

#### 3、头顶类型

- 与屏幕类型相似，UI 界面都会永远面朝摄像机，确保是会使用射线检测方法检测玩家和头顶 UI 之间是否有物体阻挡，从而控制头顶 UI 的显示/隐藏，同时计算两者之间的距离去缩放头顶 UI 实现近大远小的效果

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnmKgmjBq5zyiJcVHzX6lfx2.gif)

- 头顶类型世界 UI 包括以下属性：

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnOF8IMf72zFgc4gjb0ly3Dc.png)

- 是否可以被遮挡：头顶 UI 是否可以被建筑物等物体遮挡并隐藏，勾选则被遮挡，不勾选则不会被遮挡

![](https://wstatic-a1.233leyuan.com/static/productdocs/boxcnr9dxDZFTP5SnWUDGMgISMd.gif)
